...
struct JsonValue : pegium::AstNode {
  ...
  std::variant<std::string, double, JsonObject, JsonArray, bool, std::monostate>
      value;
};
...
public:
  ...
  Rule<Json::JsonValue> JsonValue{
      "JsonValue", assign<&JsonValue::value>(STRING | JsonArray | Number |
                                             JsonObject | JsonArray | Bool)};
