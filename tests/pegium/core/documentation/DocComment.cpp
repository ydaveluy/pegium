...
TEST(DocCommentTest, RendersInlineLinksToMarkdown) {
  EXPECT_EQ(parse_doc_comment("/** {@link https://langium.org/} */").toMarkdown(),
            "[https://langium.org/](https://langium.org/)");
  EXPECT_EQ(parse_doc_comment("/** {@linkcode https://langium.org/} */").toMarkdown(),
            "[`https://langium.org/`](https://langium.org/)");

  DocCommentRenderOptions codeLinks;
  codeLinks.link = DocCommentRenderOptions::LinkStyle::Code;
  EXPECT_EQ(parse_doc_comment("/** {@link https://langium.org/} */").toMarkdown(codeLinks),
            "[`https://langium.org/`](https://langium.org/)");
